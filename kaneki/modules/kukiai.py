    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "EnvictionAI disable by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "EnvictionAI enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
def kuki(update: Update, context: CallbackContext):
    ...
    msg = "Choose an option to activated enviction ai"
...
def ai(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get(
            "https://kukiapi.xyz/api/apikey=KUKITnhtN2I89/Enviction/Cyberhunt27/message="
            + Message
        )
