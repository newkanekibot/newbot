...
async def inline_help_func(__help__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/f2547da26d571fc79ea15.png",
            reply_markup=buttons,
        ),
        InlineQueryResultArticle(
            title="Support",
            description="Official Enviction Support.",
            input_message_content=InputTextMessageContent(
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/Envictionbot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Enviction](https://t.me/TebBotSupport)**
**MainBot:** `{bot_state}`
...
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Enviction Status",
            thumb_url="https://telegra.ph/file/f2547da26d571fc79ea15.png",
            input_message_content=InputTextMessageContent(
