...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text=" ➕ ｢ Summon Me 」➕ ",
            url="t.me/Envictionbot?startgroup=true",
        ),
    ],
    [
...
HELP_STRINGS = f"""
*Main Commands :* [Envyction](https://telegra.ph/file/3873e1f9f21ba0e43c3c5.jpg)
...
DONATE_STRING = """Hello, glad to hear you want to donate!
 You can support the project via [DANA](#) or by contacting @Cyberhunt27\
...
def kaneki_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n 🔥 Join [Envyction](https://t.me/TebBotSupport) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            ...
            f"\n\n If you have any question about *Envyction*, let us know at @TebBotSupport."
            f"\n\n👇 You Can Know More About *Envyction* By Clicking The Below Buttons 👇",
            parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_text(
            text=f"*Envyction Is the redisigned version of Daisy and Saitama And Othrer for the best performance.*"
            f"\n\nEnvyction source code was rewritten by @Cyberhunt27 and All Of Conrtibutor For Help Envyction"
            f"\n\nIf Any Question About envyction, \nLet Us Know At @TebBotSupport.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n4. **add @Envymusicassist to your group."
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@TebMusicUpdate", "⚡️")
        except Unauthorized:
            LOGGER.warning(
